...
from app.models import Facilities,UserProfile,Job,short_survey_form
from app.serializers import FacilitiesDetailSerializer,UserProfileSerializer,JobSerializer,ShortSurveySerializer,UserDetailSerializer
...
def all_data(request):
    ...
    js_job=serialize('geojson', Job.objects.all(),geometry_field='geom')
    return render(request, 'map.html',{'water_data':js_water,'education_data':js_education,'health_data':js_health,'shelter_data':js_shelter,
                                        'homeless_data':js_homeless,'donor_data':js_donor, 'job_data': js_job})
